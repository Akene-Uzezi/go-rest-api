...
func (m *AttendeeModel) Insert(attendee *Attendee, ctx context.Context) (*Attendee, error) {
...
func (m *AttendeeModel) GetByEventAndAttendee(eventId, userId int, ctx context.Context) (*Attendee, error) {
	ctx, cancel := context.WithTimeout(ctx, 3*time.Second)
	defer cancel()
...
func (m *AttendeeModel) GetAttendeesByEvent(ctx context.Context, id int) ([]*User, error) {
	ctx, cancel := context.WithTimeout(ctx, 3*time.Second)
	defer cancel()
...
func (m *AttendeeModel) Delete(userId, eventId int, c context.Context) error {
...
func (m *AttendeeModel) GetEventsByAttendee(attendeeId int, c context.Context) ([]*Event, error) {
	ctx, cancel := context.WithTimeout(c, 3*time.Second)
	defer cancel()
